...
<details>
  <summary>Details</summary>
Motivation: Multistrange baryon-baryon interactions (e.g., ΞN, ΩN) are poorly constrained but crucial for modeling neutron-star matter; theoretical and experimental hints of attraction motivate searches for weakly bound dibaryons near threshold.

Method: Analysis of 102M Υ(1S) and 158M Υ(2S) decays collected with the Belle detector at KEKB; invariant mass spectra of baryon-pair final states (Ξ⁰p, Ω⁻p, Ω⁻n) were examined near respective thresholds; background estimation and unbinned maximum-likelihood fits used to set upper limits.

Result: No statistically significant signals observed in any channel; first 90% CL upper limits on ℬ[Υ(nS) → dibaryon] established: ranging from ~1.3×10⁻⁷ to ~1.1×10⁻⁶ depending on channel and assumed mass splitting from threshold.

Conclusion: Current data do not support existence of weakly bound Ξ⁰p, Ω⁻p, or Ω⁻n dibaryons in the searched mass region; results constrain models of multistrange baryonic interactions and inform neutron-star EoS calculations.
